		...
		concat: {
			css: {
				src: ['_gh_pages/assets/css/font-awesome.min.css',
					...
					'_gh_pages/assets/css/events.css',
					'_gh_pages/assets/css/masonry.css',
					'_gh_pages/assets/css/jquery.fancybox.css',
					'_gh_pages/assets/css/breadcrumb-style.css'
				],

				dest: '_gh_pages/dist/css/madtadders.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/madtadders.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/madtadders.css',
				dest: '_gh_pages/dist/css/min/madtadders.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/madtadders.js',
				dest: '_gh_pages/dist/js/min/madtadders.min.js'
			}
		},
		watch: {
			css: {
